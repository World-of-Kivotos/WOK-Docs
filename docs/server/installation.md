...
本指南将帮助**为了获得最佳游戏体验,我们强烈推荐使用 PC 端进行游戏。**
:::

## 推荐安装方式：整合包 + PCL2


## 下载整合包Minecraft 以加入 World of Kivotos 服务器。我们强烈推荐使用整合包和 PCL2 启动器来获得最佳游戏体验。

## 关于手机端游戏体验

::: warning 手机端性能要求较高
虽然 Minecraft 支持手机端游戏，但我们的整合包对设备性能要求较高。
**建议使用搭载骁龙 8 Gen 2 或同等性能芯片的设备**才能获得比较流畅的游戏体验。

如果您对手机性能调优有丰富经验，可以尝试在手机设备上运行，但请注意：
- 低配置设备可能出现卡顿、掉帧等问题
- 需要您自行调整游戏设置和系统优化
- 我们无法为手机端提供技术支持，敬请谅解（如果后续推出了手机专属的低配整合包，我们会删除这一条目并开始提供技术支持）
- 请务必在手机端游戏前阅读此提示，并确认手机性能 meets our minimum requirements
